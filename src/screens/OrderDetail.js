...
const OrderDetail = props => {
  ...
  const {od_id, od_time, type} = props.route.params;
            ...
            <View style={{...BaseStyle.ph20}}>
              ...
              <View
                ...
                <View style={{...BaseStyle.container5}}>
                  <Text style={{...BaseStyle.ko14, ...BaseStyle.font_999}}>결제방법</Text>
                  <Text style={{...BaseStyle.ko14, ...BaseStyle.font_999}}>
          ...
          {type === "ready" ? (
            ...
            <View style={{...BaseStyle.container, width: Dimensions.get("window").width}}>
              ...
              <TouchableOpacity
                ...
                <Text style={{...BaseStyle.ko14, ...BaseStyle.font_bold}}>접수 완료</Text>
              </TouchableOpacity>
            </View>
          ) : type === "doing" ? (
            // 처리중일 경우 출력
