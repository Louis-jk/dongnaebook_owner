...
const App = () => {
  ...
  const localNoti = () => {
    PushNotification.localNotification({
      ...
      channelId: "ohjoostore", // (required) channelId, if the channel doesn't exist, notification will not trigger.
  ...
  return (
    <>
      ...
      <Toast config={toastConfig} topOffset={300} ref={ref => Toast.setRef(ref)} />
      {/* </Provider> */}
    </>
  );
};
